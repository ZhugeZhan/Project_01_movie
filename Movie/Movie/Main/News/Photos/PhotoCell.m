...
@implementation PhotoCell
{
    ...
    UIAlertController *alertCtrl; //保存时弹出的确认窗口
}
...
- (void)savePhoto:(UIGestureRecognizer *)longPress {
    ...
    alertCtrl = [UIAlertController alertControllerWithTitle:@"是否保存图片？" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    ...
    //从cell获取到[UIViewController class]视图控制器类，然后调用方法，显示alertCtrl
